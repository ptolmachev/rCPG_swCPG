# Apneusis and spont swallows when KF is inhibited
# reduction in sw when Kf is disinhibited
import json
import numpy as np
...
b[6,7] = -0.27 #NTS1 -> NTS2
b[7,6] = -0.235 #NTS2 -> NTS1
...
b[14,5] = -0.3 #NTS_inh -> Relay
b[14,6] = -0.2 #NTS_inh -> NTS1
b[14,7] = -0.2 #NTS_inh -> NTS2
b[14,8] = -0.2 #NTS_inh -> NTS2
